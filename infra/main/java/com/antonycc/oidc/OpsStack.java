...
public class OpsStack extends Stack {
    ...
    public OpsStack(final Construct scope, final String id, final OpsStackProps props) {
        ...
        IDistribution distribution = Distribution.fromDistributionAttributes(this, "CloudFrontDistribution", DistributionAttributes.builder()
        ...
        OperationsMetricOptions dynamoDbMetricOptions = OperationsMetricOptions.builder()
            .operations(List.of(Operation.GET_ITEM, Operation.PUT_ITEM, Operation.UPDATE_ITEM, Operation.DELETE_ITEM, Operation.QUERY, Operation.SCAN))
            .build();
        ...
        new CfnOutput(
                ...
                CfnOutputProps.builder().value(this.authorizeErrorAlarm.getAlarmArn()).build());
        new CfnOutput(
                this,
                "AuthorizeDurationAlarmArn",
                CfnOutputProps.builder().value(this.authorizeDurationAlarm.getAlarmArn()).build());
        new CfnOutput(
                this,
                "TokenErrorAlarmArn",
                CfnOutputProps.builder().value(this.tokenErrorAlarm.getAlarmArn()).build());
        new CfnOutput(
                this,
                "LambdaThrottleAlarmArn",
                CfnOutputProps.builder().value(this.lambdaThrottleAlarm.getAlarmArn()).build());
        new CfnOutput(
                this,
                "DynamoDbUserThrottleAlarmArn",
                CfnOutputProps.builder().value(this.dynamoDbUserThrottleAlarm.getAlarmArn()).build());
        new CfnOutput(
                this,
                "DynamoDbAuthCodeThrottleAlarmArn",
                CfnOutputProps.builder().value(this.dynamoDbAuthCodeThrottleAlarm.getAlarmArn()).build());
        new CfnOutput(
                this,
                "DynamoDbRefreshTokenThrottleAlarmArn",
                CfnOutputProps.builder().value(this.dynamoDbRefreshTokenThrottleAlarm.getAlarmArn()).build());
        new CfnOutput(
                this,
                "OperationalDashboard",
                CfnOutputProps.builder().value("https://" + this.getRegion() + ".console.aws.amazon.com/cloudwatch/home?region=" + this.getRegion() + "#dashboards:name=" + this.operationalDashboard.getDashboardName()).build());
    }
}
