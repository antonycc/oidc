...
ENV USERS_TABLE="The default value from the Dockerfile is intended to be overridden."
ENV REFRESH_TABLE="The default value from the Dockerfile is intended to be overridden."
...
CMD ["app/functions/token.handler"]
