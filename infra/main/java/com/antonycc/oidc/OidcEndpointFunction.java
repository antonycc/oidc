...
public class OidcEndpointFunction extends Construct {
  ...
  public OidcEndpointFunction(
      final Construct scope, final String id, final OidcEndpointFunctionProps props) {
    super(scope, id);
    ...
    // Log group
    this.logGroup =
        LogGroup.Builder.create(this, props.functionName + "-LogGroup")
    ...
    this.functionRole =
        Role.Builder.create(this, props.functionName + "-ServiceRole")
    ...
    AssetImageCodeProps imageCodeProps =
    ...
    var otelEnv =
        Map.of(
            ...
            "OTEL_METRICS_EXPORTER",
                "otlp", // enable metrics export to CloudWatch via Application Signals
            ...
            "OTEL_NODE_DISABLED_INSTRUMENTATIONS",
                "none", // enable all Node libs (cold-start tradeoff)
    ...
    this.function =
        DockerImageFunction.Builder.create(this, props.functionName + "-Lambda")
    ...
    this.httpOrigin =
        HttpOrigin.Builder.create(getLambdaUrlHostToken(this.functionUrl))
            .protocolPolicy(
